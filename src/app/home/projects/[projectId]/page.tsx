...
import DeleteProjectInlineButton from "./DeleteProjectInlineButton";
      ...
      <div className="max-w-[1000px] mx-auto grid grid-cols-1 md:grid-cols-[1.5fr_2fr] gap-6 md:gap-10">
            ...
            <div className="absolute top-4 right-4">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  {/* Directly use the Client Component here */}
                  <DropdownMenuItem asChild>
                    <DeleteProjectInlineButton projectId={String(project.project_id)} />
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
        ...
        <div>
          ...
          <ul className="mt-2 space-y-2 text-gray-700">
            ...
            <li><strong>Yarn Types:</strong> {project.yarn?.join(", ") || "Not specified"}</li>
            <li><strong>Pattern:</strong> {project.pattern}</li>
            <li><strong>Needle Size:</strong> {project.needle_size}</li>
            <li><strong>Difficulty Level:</strong> {project.difficulty}</li>
            {project.time_spent !== null && (
              <li><strong>Time Spent:</strong> {project.time_spent} hours</li>
            )}
          </ul>
