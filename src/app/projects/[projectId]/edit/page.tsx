		...
		<Card className="max-w-6xl mx-auto mt-10 shadow-lg p-8">
			<div className="grid grid-cols-2 gap-6">
				...
				<CardContent>
					...
					{/* Save Button */}
					<button
						className="mt-6 bg-pink-300 hover:bg-pink-400 text-white px-6 py-2 rounded-lgmt-6 bg-pink-100 hover:bg-pink-200 text-pink-700 px-6 py-2 rounded-lg border border-pink-300"
